      ...
      <div className="flex justify-between items-center container mx-auto">
        ...
        <div className='flex min-w-2xs bg-white shadow-md border p-0.5 z-11  items-center rounded-2xl'> 
           ...
           <div className='border-l-1 border-t-0 border-b-0 border-r-0   flex items-center  '>
            <Search className=' ml-2  size-5.5'/>
           <Input className=' m-0 p-1.5 border-none w-2xs rounded-tl-none rounded-bl-none  shadow-none dark: bg-white outline-none  placeholder:text-lg' placeholder='Pesquisar eventos, shows, teatro, cursos'/>
           </div>
        </div>
